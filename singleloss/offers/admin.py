from models import Session, Subject, Choice, Question
...
class SubjectAdmin(admin.ModelAdmin):
    ...
    list_filter = ['session']
    list_display = ['session_and_subject', 'indifference_point', 'alpha_estimate', 'beta_estimate', 'finished', 'diagnostic_links', 'session_diagnostic_link']    
