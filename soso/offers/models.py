...
# Disable proxy auto-detection -- necessary on prefork web servers on OS X.
urllib2.install_opener(urllib2.build_opener(urllib2.ProxyHandler(settings.PROXY_HASH)))
